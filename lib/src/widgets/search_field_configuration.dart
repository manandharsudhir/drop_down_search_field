...
/// Supply an instance of this class to the [DropDownSearchField.textFieldConfiguration]
...
class TextFieldConfiguration {
  ...
  /// A typical use case for this field in the DropDownSearchField widget is to set the
